...
import PrintingImage from "/printingservices.png";
        ...
        <div className="grid md:grid-cols-2 gap-5 items-center">
          ...
          >
            ...
            <div className="w-14 h-14 rounded-2xl bg-[#EFF6FF] flex items-center justify-center">
              <Printer size={25} className="text-primary"/>
            </div>
            ...
            <p className="text-text text-sm md:text-lg leading-relaxed mt-4 max-w-2xl">
              Elevate your brand with premium quality printing
              solutions. From business cards to large scale
              corporate branding.
            </p>
